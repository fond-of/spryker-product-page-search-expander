...
class ModelShortDataExpanderPlugin extends AbstractPlugin implements ProductPageDataExpanderInterface
{
    ...
    public function expandProductPageData(
        ...
        if (array_key_exists(ProductPageSearchExpanderConstants::MODEL_SHORT, $productAttributes)) {
            $productAbstractPageSearchTransfer->setModelShort($productAttributes[ProductPageSearchExpanderConstants::MODEL_SHORT]);
        }
    }
}
