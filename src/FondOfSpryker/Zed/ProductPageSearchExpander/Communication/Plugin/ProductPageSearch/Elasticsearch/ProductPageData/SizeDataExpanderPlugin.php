...
class SizeDataExpanderPlugin extends AbstractPlugin implements ProductPageDataExpanderInterface
{
    ...
    public function expandProductPageData(
        ...
        if (array_key_exists(ProductPageSearchExpanderConstants::SIZE, $productAttributes)) {
            $productAbstractPageSearchTransfer->setSize($productAttributes[ProductPageSearchExpanderConstants::SIZE]);
        }
    }
}
