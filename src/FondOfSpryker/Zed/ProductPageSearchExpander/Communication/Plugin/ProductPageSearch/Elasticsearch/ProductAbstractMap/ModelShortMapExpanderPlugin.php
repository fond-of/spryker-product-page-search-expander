 ...
 */
class ModelShortMapExpanderPlugin extends AbstractPlugin implements ProductAbstractMapExpanderPluginInterface
{
    /**
     * Specification:
    ...
    public function expandProductMap(
        ...
        if (isset($productData[ProductPageSearchExpanderConstants::MODEL_SHORT])) {
            $pageMapTransfer->setModelShort($productData[ProductPageSearchExpanderConstants::MODEL_SHORT]);
        }
