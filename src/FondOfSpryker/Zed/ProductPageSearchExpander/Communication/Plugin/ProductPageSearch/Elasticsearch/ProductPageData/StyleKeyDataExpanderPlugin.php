...
class StyleKeyDataExpanderPlugin extends AbstractPlugin implements ProductPageDataExpanderInterface
{
    ...
    public function expandProductPageData(
        ...
        if (array_key_exists(ProductPageSearchExpanderConstants::STYLE_KEY, $productAttributes)) {
            $productAbstractPageSearchTransfer->setStyleKey($productAttributes[ProductPageSearchExpanderConstants::STYLE_KEY]);
        }
    }
}
